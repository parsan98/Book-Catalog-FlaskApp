...
User1 = User(name="Rize Kamishiro", email="rize@fakemail.com",
             picture='https://vignette.wikia.nocookie.net/thetokyoghoul/images/6/6a/Rize_Kamishiro_Profile.png/revision/latest?cb=20150715151145')
session.add(User1)
session.commit()

User2 = User(name="Light Yagami", email="lyagami@fakemail.com",
             picture='https://imgix.ranker.com/user_node_img/50081/1001613426/original/i-and-_39_ll-take-a-potato-chip-and-eat-it-photo-u1?w=650&q=50&fm=jpg&fit=crop&crop=faces')
session.add(User2)
session.commit()

User3 = User(name="Mayuri Shiina", email="mayuri@fakemail.com",
             picture='https://sep.yimg.com/ay/yhst-91547409642223/steins-gate-mayuri-shiina-cosplay-13.gif')
session.add(User3)
session.commit()
...
Fantasy = Genre(name="Fantasy",
                icon='https://is5-ssl.mzstatic.com/image/thumb/Purple122/v4/79/8c/df/798cdfed-8d1f-1cab-be14-89d761e9b4c8/source/256x256bb.jpg')
session.add(Fantasy)
session.commit()

ScienceFiction = Genre(name="Science Fiction",
                icon='https://is5-ssl.mzstatic.com/image/thumb/Purple62/v4/0e/54/f8/0e54f841-d25e-788f-68d9-459cf5bb0b66/source/256x256bb.jpg')
session.add(ScienceFiction)
session.commit()

Classics = Genre(name="Classics",
                icon='https://aardvarkian.files.wordpress.com/2011/10/56_classics_431.jpg')
...
Mystery = Genre(name="Mystery",
                icon='https://is3-ssl.mzstatic.com/image/thumb/Purple128/v4/d2/32/c9/d232c9b9-cc4d-5c87-fa0c-fb0e6833c64a/source/256x256bb.jpg')
session.add(Mystery)
session.commit()

Biography = Genre(name="Biography",
                icon='https://tse.mm.bing.net/th?id=OIP.nbGsUD3Rs1_kYypqsaZ3XQAAAA')
session.add(Biography)
session.commit()

SelfHelp = Genre(name="Self Help",
                icon='https://cdn.24.co.za/files/Cms/General/d/4482/dc628be03e8744118b959fcc2ad2ca43.jpg')
...
principal story chronicles the power struggle for the Iron Throne \
among the great Houses of Westeros following the death of \
King Robert.",
             cover='https://upload.wikimedia.org/wikipedia/en/d/dc/A_Song_of_Ice_and_Fire_book_collection_box_set_cover.jpg',
...
guarded by Smaug the dragon.",
             cover='http://t3.gstatic.com/images?q=tbn:ANd9GcQzlnFVCU2ZcD1K0_5dHip_Uv-fIMCAx3i10XbqWgKLZO9GouV6',
...
the Earth. He, his nephew Axel, and their guide Hans descend into \
the Icelandic volcano Snaefellsjokull, encountering many adventures",
             cover='https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/A_Journey_to_the_Centre_of_the_Earth-1874.jpg/330px-A_Journey_to_the_Centre_of_the_Earth-1874.jpg',
...
coloured by a psychological intensity.",
             cover='https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Jane_Eyre_title_page.jpg/330px-Jane_Eyre_title_page.jpg',
...
Jeeves and Bertie Wooster, after Thank You, Jeeves.",
             cover='https://upload.wikimedia.org/wikipedia/en/8/83/RightHoJeeves.jpg',
...
Jerome K. Jerome of a two-week boating holiday on the Thames from \
Kingston upon Thames to Oxford and back to Kingston.",
             cover='https://images-na.ssl-images-amazon.com/images/I/71iCUnY11ML.jpg',
...
detecting abilities. ",
             cover='https://upload.wikimedia.org/wikipedia/en/b/bf/The_Murder_at_the_Vicarage_First_Edition_Cover_1930.jpg',
...
of his wife.",
             cover='https://images-na.ssl-images-amazon.com/images/I/516Gb2s1eGL._SX324_BO1,204,203,200_.jpg',
...
lung cancer. It was posthumously published by Random House on \
             January 12, 2016.",
             cover='https://upload.wikimedia.org/wikipedia/en/d/dd/When_Breath_Becomes_Air.jpg',
...
access to Jobs's life",
             cover='https://upload.wikimedia.org/wikipedia/en/e/e4/Steve_Jobs_by_Walter_Isaacson.jpg',
...
book14 = Book(name="7 Habits of Highly Effective People", author="Steven R Covey",
...
universal and timeless.",
             cover='https://upload.wikimedia.org/wikipedia/en/a/a2/The_7_Habits_of_Highly_Effective_People.jpg',
